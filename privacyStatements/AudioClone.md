...
- **您在设备上产生的音频数据** 我们需要这些信息来实现本应用程序的基本功能—采集音频并在其他设备上播放。
...
- 一般情况下，你在设备上产生的音频数据不会被除了局域网上已配对的设备上获取，除非出现满足以下任意一条的情况下，你授权并同意了客户端的连接请求：
  - 您在您的设备上主动使用了实现诸如“内网穿透”等功能的软件，您的网络上存在端口转发设备，或者您的设备、你设备所在的局域网的某台计算机上有病毒等软件转发了我们提供服务的端口。
  - 您的一个或多个“以太网”（或类似技术）连接直接暴露在互联网上（没有经过地址转换等步骤），且您启用了“设置-后端设置”中的“允许与非局域网地址配对”选项。
